...
from .population.population_menu import PopulationMenuManager
...
bollinger_menu_items = [
    create_command(
        ...
        description="Testa il gene Bollinger su dati storici"
    ),
    create_command(
        name="Visualizza Parametri",
...
gene_menu_items = [
    create_submenu(
        ...
        description="Gestione gene RSI"
    ),
    create_submenu(
        name="Moving Average",
        items=moving_average_menu_items,
        description="Gestione gene Moving Average"
    ),
    create_submenu(
        name="MACD",
        items=macd_menu_items,
        description="Gestione gene MACD"
    ),
    create_submenu(
        name="Bollinger",
...
all_menu_items = [
    ...
    create_submenu(
        ...
        description="Gestione popolazioni di trading"
    )
]
